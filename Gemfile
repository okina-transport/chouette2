...
gem 'devise-i18n'
gem 'chouette2-i18n', git: 'https://github.com/okina-transport/chouette2-i18n.git', :branch => 'master'
gem 'chouette-projects-i18n', git: 'https://github.com/okina-transport/chouette-projects-i18n.git', :branch => 'master'
