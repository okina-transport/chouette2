class LinesController < ChouetteController
  ...
  def line_params
    ...
    :object_version, :creation_time, :creator_id, :name, :number, :published_name, :operator, :codifligne, :categories_for_line_id, :codifligneCommercial,
    :categories_for_line_id, :partenaire,
